...
- **Multi-Source Tracking**: Aggregate chapters from MangaDex, NeloManga, MangaPlus, Comikey, Atsumaru, Webtoon, Manganato, MangaPill, and more.
...
- `npm run source:compare`: runs the live source quality comparison harness.
