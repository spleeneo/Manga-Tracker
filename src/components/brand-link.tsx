...
export function BrandLink() {
  return (
    ...
    >
      <span className="flex h-11 w-14 items-center justify-center rounded-lg border border-border bg-white p-1 shadow-sm dark:bg-black">
        <Image
          src="/mangateo-logo.png"
          alt=""
          width={48}
          height={34}
          className="h-8 w-12 object-contain dark:invert"
          priority
        />
      </span>
