...
export function BrandLink() {
  return (
    ...
    >
      <span className="flex h-10 w-12 items-center justify-center rounded-md border border-border/70 bg-white p-0.5 shadow-sm dark:border-white/20 dark:bg-muted">
        <Image
